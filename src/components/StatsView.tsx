...
export default function StatsView({ bets }: { bets: BetWithLegs[] }) {
  ...
  const inputClass =
    "mt-1 block h-11 w-full rounded-xl border border-neutral-300 bg-white px-3 text-base text-neutral-900 outline-none focus:border-[#E5D283] dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-100";
    ...
    <main className="min-h-dvh px-4 py-6 sm:px-6">
      <div className="mx-auto w-full max-w-md space-y-5">
        <header className="flex items-center justify-between">
          ...
          <Link
            href="/app"
            className="rounded-lg bg-[#E5D283] px-4 py-2 text-sm font-bold text-[#213555] active:bg-[#D6C070]"
          >
            Home
          </Link>
        </header>
        ...
        {filtered.length === 0 ? (
          ...
          <>
            ...
            <Link
              ...
              className="block h-12 w-full rounded-xl bg-[#213555] text-center text-base font-bold leading-[3rem] text-[#E5D283] active:bg-[#16233A]"
            >
              {sport !== null
