  ...
  return (
    <div>
      <button
        ...
        onClick={signIn}
        disabled={loading}
        className={`flex w-full items-center justify-center gap-3 rounded-xl border border-neutral-300 bg-white font-semibold text-neutral-800 disabled:opacity-60 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 ${
