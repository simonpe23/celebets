  ...
  return (
    <div>
      <button
        ...
        onClick={signIn}
        disabled={loading}
        className={`flex w-full items-center justify-center gap-3 rounded-xl border border-neutral-300 bg-white font-semibold text-neutral-800 disabled:opacity-60 dark:border-white/15 dark:bg-[#1A2032] dark:text-neutral-100 ${
