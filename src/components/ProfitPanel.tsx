...
export default function ProfitPanel({
  ...
  return (
    <section className="overflow-hidden rounded-3xl bg-[#17102A] p-4 dark:bg-[#151022] shadow-[0_18px_40px_-20px_rgba(16,19,34,0.9)] ring-1 ring-white/5">
