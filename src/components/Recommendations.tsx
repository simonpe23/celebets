  ...
  return (
    <>
      <button
        type="button"
        onClick={roll}
        className="rounded-xl bg-[#58287F] px-3 py-2.5 text-center text-xs font-bold text-white active:bg-[#431E63]"
      >
        Recommendations
      </button>
          ...
          <div className="w-full max-w-sm rounded-t-2xl bg-white p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] sm:rounded-2xl sm:pb-6 dark:bg-neutral-900">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="rounded-lg bg-[#58287F] px-4 py-2 text-sm font-bold text-white active:bg-[#431E63]"
              >
                Hide
              </button>
            </div>
