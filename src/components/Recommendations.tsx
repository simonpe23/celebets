          ...
          <div className="w-full max-w-sm rounded-t-2xl bg-white p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] sm:rounded-2xl sm:pb-6 dark:bg-neutral-900">
            ...
            <div className="mt-5 flex items-center justify-between gap-2">
              <button
                type="button"
                onClick={roll}
                className="rounded-lg border border-[#58287F] px-4 py-2 text-sm font-semibold text-[#58287F] dark:text-[#A97FD0]"
              >
                New mix
              </button>
              <Link
                href="/recommendations"
                className="text-sm font-semibold text-[#58287F] underline underline-offset-2 dark:text-[#A97FD0]"
              >
                Show all
              </Link>
            </div>
