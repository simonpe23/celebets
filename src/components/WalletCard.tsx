      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex shrink-0 flex-col gap-2">
          <button
            ...
            className="rounded-xl bg-[#E5D283] px-3 py-2.5 text-xs font-semibold text-[#213555] active:bg-[#D6C070]"
          >
            Deposit
          </button>
          <Link
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 sm:items-center">
          <div className="w-full max-w-sm rounded-t-2xl bg-white p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] sm:rounded-2xl sm:pb-6 dark:bg-neutral-900">
            ...
            <input
              ...
              className="mt-1 block h-12 w-full rounded-xl border border-neutral-300 bg-white px-4 text-base text-neutral-900 outline-none focus:border-[#E5D283] focus:ring-2 focus:ring-[#E5D283]/50 dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-100"
            />
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="h-12 rounded-xl bg-[#E5D283] text-base font-semibold text-[#213555] active:bg-[#D6C070] disabled:opacity-60"
              >
                Deposit
              </button>
            </div>
