      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex shrink-0 flex-col gap-2">
          <button
            ...
            className="rounded-xl bg-[#E5D283] px-3 py-2.5 text-xs font-bold text-[#213555] active:bg-[#D6C070]"
          >
            Start here
          </button>
          <Link
          ...
          <div className="w-full max-w-sm rounded-t-2xl bg-white p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] sm:rounded-2xl sm:pb-6 dark:bg-neutral-900">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="h-12 rounded-xl bg-[#E5D283] text-base font-bold text-[#213555] active:bg-[#D6C070] disabled:opacity-60"
              >
                Deposit
              </button>
            </div>
