                  ...
                  <div className="mt-3 rounded-xl bg-neutral-100 p-3 dark:bg-neutral-900">
                    ...
                    <div className="mt-2 flex justify-end gap-2">
                      ...
                      <button
                        ...
                        className="rounded-lg bg-[#E5D283] px-3 py-1.5 text-xs font-bold text-[#213555] disabled:opacity-50"
                      >
                        Confirm add
                      </button>
                    </div>
                        ...
                        {leg.result === "pending" ? (
                          <>
                            <button
                              ...
                              className="h-9 flex-1 rounded-lg bg-[#E5D283] text-sm font-bold text-[#213555] active:bg-[#D6C070] disabled:opacity-50"
                            >
                              Won
                            </button>
                            <button
