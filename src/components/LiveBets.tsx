                    ...
                    {bet.status === "pending" && (
                      <>
                        <button
                          ...
                          className="rounded-lg border border-[#3E5F44] px-3 py-1.5 text-xs font-medium text-[#3E5F44] disabled:opacity-50 dark:text-[#3E5F44]"
                        >
                          Add money
                        </button>
                        <button
                  ...
                  <div className="mt-3 rounded-xl bg-neutral-100 p-3 dark:bg-neutral-900">
                    ...
                    <div className="mt-2 flex justify-end gap-2">
                      ...
                      <button
                        ...
                        className="rounded-lg bg-[#3E5F44] px-3 py-1.5 text-xs font-bold text-white disabled:opacity-50"
                      >
                        Confirm add
                      </button>
                    </div>
                        ...
                        {leg.result === "pending" ? (
                          <>
                            <button
                              ...
                              className="h-9 flex-1 rounded-lg bg-[#3E5F44] text-sm font-bold text-white active:bg-[#2F4A34] disabled:opacity-50"
                            >
                              Won
                            </button>
                            <button
