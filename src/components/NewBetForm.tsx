...
export default function NewBetForm({ lastStake }: Props) {
  ...
  const inputClass =
    "mt-1 block h-12 w-full rounded-xl border border-neutral-300 bg-white px-4 text-base text-neutral-900 outline-none focus:border-[#213555] focus:ring-2 focus:ring-[#213555]/40 dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-100";
    ...
    <section className="rounded-2xl border border-neutral-300/70 bg-[#F2F4F7] dark:bg-neutral-950 p-5 dark:border-neutral-800">
      ...
      <div className="mt-3 grid grid-cols-2 gap-2">
        <button
          ...
          disabled={importing}
          onClick={pasteSlip}
          className="h-11 rounded-xl bg-[#213555] text-sm font-semibold text-[#E5D283] active:bg-[#16233A] disabled:opacity-50"
        >
          Paste bet slip
        </button>
        <button
        ...
        {(lastStake !== "" && !QUICK_STAKES.includes(lastStake)
          ...
          <button
            ...
            className={`shrink-0 whitespace-nowrap rounded-lg border px-3 py-1.5 text-xs font-semibold ${
              stake === amount
                ? "border-[#213555] text-emerald-600 dark:text-emerald-400"
            ...
            {SPORTS.map((s) => (
              <button
                ...
                className={`shrink-0 whitespace-nowrap rounded-xl border px-4 py-2.5 text-sm font-semibold ${
                  leg.sport === s
                    ? "border-[#213555] bg-[#213555] text-[#E5D283]"
      ...
      <button
        ...
        disabled={!canPlace}
        onClick={placeBet}
        className="mt-4 h-14 w-full rounded-xl bg-[#213555] text-lg font-bold text-[#E5D283] active:bg-[#16233A] disabled:opacity-40"
      >
