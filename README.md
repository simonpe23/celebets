...
1. Create a Supabase project and run `supabase/schema.sql`, then `supabase/phase2.sql`, `supabase/phase3.sql`, `supabase/phase3b.sql`, `supabase/phase4.sql`, `supabase/phase4b.sql`, `supabase/phase5.sql`, `supabase/phase5b.sql`, `supabase/phase5c.sql`, `supabase/phase6.sql`, and `supabase/phase7.sql` in the SQL Editor.
