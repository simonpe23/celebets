...
1. Create a Supabase project and run `supabase/schema.sql`, then `supabase/phase2.sql`, `supabase/phase3.sql`, `supabase/phase3b.sql`, `supabase/phase4.sql`, and `supabase/phase4b.sql` in the SQL Editor.
